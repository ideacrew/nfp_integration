module NfpIntegration
  module SoapServices
    class NfpCurrentStatementSummary

      SOAP_ACTION = "http://www.nfp.com/schemas/hbcore/IPremiumBillingIntegrationServices/GetCustomerCurrentStatement"
